                                                            ...
                                                            <tbody>
                                                                ...
                                                                <c:forEach items="${sessionScope.cartItem}" var="c">
                                                                    <tr id="Product${c.productId.productID}">
                                                                        <td style="padding-top: 35px" scope="row">
                                                                            <div class="p-2">
                                                                        ...
                                                                        <td class="align-middle " >
                                                                            <div class="center">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input style="width: 30px;" type="text"  class="form-control input-number" name="quantity" id="${c.productId.productID}" value="${c.quantity}" min="1" max="100">
                                                                                    <span class="input-group-btn">
                                                    ...
                                                    <div class="p-4">
                                                        <ul class="list-unstyled mb-4">
                                                            ...
                                                            <li class="d-flex justify-content-between py-3 border-bottom"><strong  class="text-muted">Tổng thanh toán</strong>
                                                                ...
                                                                <c:set var="total" value="${cartTotal}"/>
                                                            </li>
                                                            <li class="d-flex justify-content-between py-3 border-bottom"><strong  class="text-muted">Ngày đặt</strong>
                                                                <c:set var="doo" value="${doo }"/>

                                                                <input  type="date" class="form-control" id="doo" name="doo" value="${doo}">
                                                            </li>
                                                            <li class="d-flex justify-content-between py-3 border-bottom"><strong  class="text-muted">Nhà cung cấp</strong>
                                                                
                                                                <select  name="supplier" class="form-select" aria-label="Default select example">
                                                                                <c:forEach items="${sessionScope.supplier}" var="o">
                                                        ...
                                                        </ul><button class="btn btn-dark rounded-pill py-2 btn-block">Đặt Hàng</button>
                                                    </div>
