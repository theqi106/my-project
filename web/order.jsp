                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Orders /</span> Manage Orders Tables</h4><div class="dropdown">
                                    <button class="dropbtn">Soft by Supplier</button>
                                    <div class="dropdown-content">
                                        <c:forEach items="${sessionScope.supplier}" var="o">
                                        <a href="softsupplier?sid=${o.getId()}">${o.getName()}</a>
                                    </c:forEach>
                                    </div>
                                </div>
                            <div class="dropdown1">
                            <div class="dropdown">
                                    <button class="dropbtn">Soft by status</button>
                                    <div class="dropdown-content">
                                        <a href="softstatus?status=pending">pending</a>
                                        <a href="softstatus?status=confirm">confirm</a>
                                        <a href="softstatus?status=shipping">shipping</a>
                                        <a href="softstatus?status=done">done</a>
                                    </div>
                                </div>
                                </div>
                            <div class="card">
