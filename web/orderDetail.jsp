                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        ...
                                        <c:forEach items="${sessionScope.orderdetail}" var="item">
                                            <tr>
                                                ...
                                                <c:set var="total" value="${total + item.getTotalPayment() }"/>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="fw-bold">
                                            ...
                                            <td class="text-end">${total*11/10}VND   </td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <p>COD <br>
                                            Total:${total*11/10}VND  <span class="badge bg-success rounded-pill" id="statusOrder" style="color: white;"> ${order.getStatus()}</span></p>
                                    </div>
                                    <div class="col-lg-4">
                                        <h3 class="h6">Bill</h3>
                                        <address>
                                    ...
                                    <div class="col-lg-4">
                                        <h3 class="h6">Day of order</h3>
                                        <address>
                                            <strong>${order.getDayOfOrder()}</strong><br>
                                           <br>
                                           <br>
                                           
                                            <abbr title="Time">Delivery time : 3 or 4 days</abbr>
                                        </address>
                                    </div>
                                    <div class="col-lg-4">
                                        <h3 class="h6">Supplier : ${order.getSupplier().getName()}</h3>
                                        <address>
                                            <strong></strong><br>
                                           <br>
                                           <br>
                                           
                                            <abbr title="Time">Phone : ${order.getSupplier().getTelNum()}</abbr>
                                        </address>
                                    </div>
                                </div>
                            </div>
