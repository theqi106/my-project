                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="menu-sub">
                                ...
                                <li class="menu-item">
                                    <a href="forgotPassword.jsp" class="menu-link" target="_blank">
                         ...
                         <div class="content-wrapper">
                             <div class="container-xxl flex-grow-1 container-p-y" style="margin-left: 150px">
                            <img class="w-100" src="https://png.pngtree.com/png-clipart/20211026/original/pngtree-school-supplies-png-image_1476415.png" >
                         </div>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Supplier /</span> Manage Supplier Tables</h4>
                            <div class="card">
                                <h5 class="card-header">Supplier information</h5>
                                <a data-bs-target="#addEmployeeModal"  class="btn btn-success " data-bs-toggle="modal" ><i class="material-icons">&#xE147;</i> <span>Add New Supplier</span></a>
